...
def sqr_trian(a, b): #функция квадратного треугольника
    return 0.5*a * b

def sqr(a, b): #функция квадрата
    return a*b

def crcl(a): #функция круга
    return math.pi*a

def pyr(a, b): #функция пирамиды
    return 0.33 * a * b

def kyb(a): #функция куба
    return a ** 3
